...
test('Home V2 production shell keeps the white-gold cache key and five-column navigation', async () => {
  ...
  assert.match(index, /styles\.css\?v=20\.1-spaceverse-white-gold-home/);
  assert.match(index, /app\.js\?v=20\.1-spaceverse-white-gold-home/);
  assert.match(shell, /CANONICAL_STYLE_VERSION = '20\.1-spaceverse-white-gold-home'/);

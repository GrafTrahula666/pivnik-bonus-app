...
const HOME_LEAGUE_STYLE_VERSION = `${CANONICAL_STYLE_VERSION}-league-portrait-20260925-v2-home-cards-20260926-unified-back`;
const HOME_WHEEL_APP_VERSION = `${CANONICAL_STYLE_VERSION}-wheel-reference-20260926-unified-back`;
